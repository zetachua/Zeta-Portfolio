...
const SvgButton = styled.button`
  ...
  animation: ${fadeInRotate} .5s ease-out forwards, ${bobbing} 3s ease-in-out 1s infinite;;
...
const ContainerAnimation =styled.div`
  ...
  right: 5%;
  font-size: 1rem;
  color: #DBC2F7; /* Set color for the text */
  padding: 5px 10px;
  border-radius: 5px;
  z-index: 10;
...
export function DownloadButton() {
  const handleDownload = () => {
    ...
    link.href = process.env.PUBLIC_URL + "/Resume.pdf"; // Replace with the actual path
